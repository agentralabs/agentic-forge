...
echo ""
echo "  MCP Server:  aforge serve --mode stdio"
echo "  CLI:         aforge --help"
echo "  Test:        aforge info"
echo ""
echo "  MCP clients: Compatible with Claude Desktop, Codex, Cursor,"
echo "               Windsurf, VS Code, Cline, and any MCP client."
echo ""
echo "  Quick test:  aforge blueprint create test --domain api --description test"
echo ""
echo "  Restart your MCP client to pick up configuration changes."
echo ""
